...
return (<div class="py-12 bg-white">
  <div class="max-w-xl mx-auto px-4 sm:px-6 lg:max-w-screen-xl lg:px-8">
    <div class="lg:grid lg:grid-cols-3 lg:gap-8">
      <div>
        <div class="flex items-center justify-center h-12 w-12 rounded-md text-lavande-900">
          <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V5.5A2.5 2.5 0 109.5 8H12zm-7 4h14M5 12a2 2 0 110-4h14a2 2 0 110 4M5 12v7a2 2 0 002 2h10a2 2 0 002-2v-7" />
          </svg>
        </div>
        <div class="mt-5">
          <h5 class="text-xl leading-6 font-bold text-gray-900 font-mono">Les plus du Petit Gustave</h5>
      ...
      <div class="flex items-center justify-center h-12 w-12 rounded-md text-lavande-900">
        ...
        <div class="mt-5">
          <h5 class="text-xl leading-6 font-bold text-gray-900 font-mono">Accès des voyageurs</h5>
          <p class="mt-2 text-base leading-6 text-gray-500">
      ...
      <div class="flex items-center justify-center h-12 w-12 rounded-md text-lavande-900">
        ...
        <div class="mt-5">
          <h5 class="text-xl leading-6 font-bold text-gray-900 font-mono">Pas de bouchon</h5>
          <p class="mt-2 text-base leading-6 text-gray-500">
