  ...
  <div class="max-w-xl mx-auto px-4 sm:px-6 lg:max-w-screen-xl lg:px-8">
    <div class="lg:grid lg:grid-cols-3 lg:gap-8">
      <div>
        ...
        <div class="mt-5">
          <h5 class="text-lg leading-6 font-medium text-gray-900">Les plus du Petit Gustave</h5>
      ...
      <div class="mt-10 lg:mt-0">
        ...
        <div class="mt-5">
          <h5 class="text-lg leading-6 font-medium text-gray-900">Accès des voyageurs</h5>
          <p class="mt-2 text-base leading-6 text-gray-500">
      ...
      <div class="mt-10 lg:mt-0">
        ...
        <div class="mt-5">
          <h5 class="text-lg leading-6 font-medium text-gray-900">Pas de bouchon</h5>
          <p class="mt-2 text-base leading-6 text-gray-500">
