            ...
            <div class="mt-8">
              ...
              <ul class="mt-8 lg:grid lg:grid-cols-2 lg:col-gap-8 lg:row-gap-5">
                <li class="flex items-start lg:col-span-1">
                  ...
                  Un diner de produits locaux vous attendent dans le réfrigérateur: caillettes, ravioles, picodon,   et bouteille de vin de Côte du Rhône
                  </p>
                </li>
                <li class="mt-5 flex items-start lg:col-span-1 lg:mt-0">
                  ...
                  <p class="ml-3 text-sm leading-5 text-gray-700">
                    les clefs de la maison et de la piscine
                  </p>
                </li>
                <li class="mt-5 flex items-start lg:col-span-1 lg:mt-0">
                  <div class="flex-shrink-0">
