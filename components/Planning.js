const Planning = ({planning, openModal}) => {
  ...
  <div className="-ml-4 -mt-2 flex items-center justify-between flex-wrap sm:flex-no-wrap">
    ...
    {/* <ul className="h-50v overflow-scroll">
        ...
        return(
            <li key={plan.sys.id}>
            <a href="#" onClick={openModal} className="block hover:bg-gray-50 focus:outline-none focus:bg-gray-50 transition duration-150 ease-in-out">
            <div className="px-4 py-4 sm:px-6">
                ...
                <div className="mt-2 flex items-center text-xl leading-5 text-gray-800 sm:mt-0 font-bold ">
                    <span>
                        {plan?.fields?.prix}€
                    </span>
                </div>
                ...
                <div className="sm:flex">
                    {plan?.fields?.disponible ? <div className="mr-6 flex items-center text-sm leading-5 text-gray-500">
