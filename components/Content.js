...
<div class="relative py-16 bg-white overflow-hidden">
  ...
  <div class="relative px-4 sm:px-6 lg:px-8">
    <div class="text-lg max-w-prose mx-auto mb-6">
        <p class="text-base text-center leading-6 text-bles-400 font-semibold tracking-wide uppercase">{ficheTechnique.fields.label}</p>
    ...
    <div class="bg-white">
        <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 md:py-16 lg:px-8 lg:py-20">
            <h2 class="text-3xl leading-9 font-extrabold tracking-normal text-gray-900 sm:text-4xl sm:leading-10 font-mono">
